...
namespace Web.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UserDbContext>(options => options.UseSqlServer($"Server=ARTHUR;Database=Arthur_users;Trusted_Connection=True;"), ServiceLifetime.Scoped);

            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<UserDbContext>()
                .AddDefaultTokenProviders();

            services.AddDbContext<InventoryContext>(options => options.UseSqlServer($"Server=ARTHUR;Database=Arthur_inventory;Trusted_Connection=True;"), ServiceLifetime.Scoped);
